...
#SBATCH --job-name=ensemble_Label    # user-defined job name
#SBATCH --output=Outputs/slurm_ensemble_label.out
...
#---------------------------------------------------------------------------------
# Execute
srun python ensemble_tag.py > Outputs/ensemble_label.out
