...
#SBATCH --job-name=exclusion_test    # user-defined job name
#SBATCH --output=Outputs/slurm_general_exclusion.out
...
#---------------------------------------------------------------------------------
# Execute
srun python tag_sentiment_exclusion_test.py > Outputs/general_exclusion.out
