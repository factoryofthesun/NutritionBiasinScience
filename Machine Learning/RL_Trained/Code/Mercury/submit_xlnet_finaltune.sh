...
#SBATCH --job-name=xlnet_final    # user-defined job name
#SBATCH --output=Outputs/slurm_xlnet_final.out
...
#---------------------------------------------------------------------------------
# Execute
srun python xlnet_seqclass_finaltune.py > Outputs/xlnet_final.out
