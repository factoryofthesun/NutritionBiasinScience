...
#SBATCH --job-name=xlnet_finalv3    # user-defined job name
#SBATCH --output=Outputs/slurm_xlnet_finalv3.out
...
#---------------------------------------------------------------------------------
# Execute
srun python xlnet_seqclass_finaltune_v3.py > Outputs/xlnet_finalv3.out
