...
#SBATCH --job-name=xlnet_healthbase    # user-defined job name
#SBATCH --output=Outputs/slurm_xlnet_healthbase.out
...
#---------------------------------------------------------------------------------
# Execute
srun python xlnet_related_base.py > Outputs/xlnet_healthbase.out
